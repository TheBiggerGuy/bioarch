...
class OccupationalMarkers(object):  # pylint: disable=R0902
    ...
    def __init__(self, c_trapezius, c_o_deltiod, c_o_pectoralis_major, c_costoclaviclar_lig, c_subcalvius, c_conoid_lig, c_trapezoid_lig, s_pectoralis_minor, s_serratus_anterior, s_triceps_long_head, s_trapezius, h_subscapularis, h_teres_major, h_latissimus_dorsi, h_pectoralis_major, h_deltoid, h_coracobrachialis, h_supraspinatus, h_infraspinatus, h_teres_minor, h_o_extensor, h_o_flexor, u_brachialis, u_o_pronator_quadrataus, u_triceps_brachii, u_anconeus, u_o_supinator, r_biceps_brachii, r_supinator, r_pronator_teres, r_pronator_quadratus, r_brachoradialis, f_gluteus_minimus, f_gluteus_medius, f_piriformus, f_obturator_internus, f_obturator_externus, f_quadratis_femoris, f_ilioposas, f_gluteus_maximus, f_pectineus, f_o_vastus_medialis, f_o_vastus_lateralis, o_adductor_magnus, f_o_gastrocnemius, f_o_plantaris, f_o_popliteus, t_tensor_fascia_latae, t_quadriceps, t_sartorius, t_gracilis, t_semitendinosus, t_o_tibialus_anterior, t_biceps_femoris, t_semimembranosus, t_popliteus, t_o_soleus, t_o_tibialis_posterior, t_o_flexor_digitorium, f_biceps_femoris, f_o_extensor_muscles, f_o_flexor_muscles, f_o_peroneus_longus, f_o_peronus_brevis, f_o_soleus, p_quadriceps, c_achilles):
    ...
    @staticmethod
    def empty():
        markers = [LeftRight(None, None)] * 67
